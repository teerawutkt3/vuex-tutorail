        ...
        <b-row>
                        ...
                        <b-row>
                            <b-col md="6" sm="6" lg="6">
                                <b-form-group>
                                    ...
                                    <date-picker v-model="time1" valueType="format" :format="momentFormat"
            ...
            <b-col cols="12" sm="12" md="4" lg="4" xl="6" class="mb-3">
                <b-card :header="true" :shadow="'lg'">
                    ...
                    <template v-slot:body>
                        <b-form-group>
                            <b><icon :icon="'fa-calendar'"/> Now month : </b>{{nowMonth}}
                        </b-form-group>
                        <b-form-group>
                        ...
                        <b-form-group>
                            <b>Summary <span class="text-primary">bill active</span>: {{summaryBillActive | currency}}</b>
                        </b-form-group>
                    </template>
                </b-card>
            </b-col>
            ...
            <template v-slot:body>
                <table id="table-bill" class="table table-striped table-sm table-hover nowrap" width="100%">
                        ...
                        <th class="text-right">
                            <div class="custom-control  custom-checkbox my-1 mr-sm-2">
                                <input type="checkbox" class="custom-control-input" value="Y"
                                       @click="checkAll($event)" id="checkAll">
                    ...
                    <tr v-for="(item,index) in items" v-bind:key="item.id">
                        <td class="text-right">
                            <div class="custom-control custom-checkbox my-1 mr-sm-2">
                                <input type="checkbox" v-model="checkedIsShow" @change="checkIsCheckAll"
                                       class="custom-control-input"
                                       :value="item.id" :id="'isShow'+index">
